# hltGetConfiguration /users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V5 --globaltag auto:run2_hlt_HIon --l1-emulator uGT --era Run2_2018_pp_on_AA --input root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIMinimumBias2/RAW/v1/000/327/564/00000/FE6DDFF0-F95A-FA4A-8C78-A43B90A36F06.root --process MyHLT --full --data --unprescale --timing --no-output --max-events -1 --customise HLTrigger/Configuration/customizeHLTforCMSSW.synchronizeHCALHLTofflineRun3on2018data

# /users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V5 (CMSSW_11_1_0_pre5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V5')
)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HIL3DoubleMuOpen_v1, process.HLT_HIL3Mu12_v1, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIMinimumBias2/RAW/v1/000/327/564/00000/FE6DDFF0-F95A-FA4A-8C78-A43B90A36F06.root',
    ),
...
_customInfo['inputFile' ]=  ['root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIMinimumBias2/RAW/v1/000/327/237/00000/0005865D-0454-A04C-A742-72C446B8D554.root']
...
massSearchReplaceAnyInputTag(process.SimL1EmulatorTask, cms.InputTag("rawDataCollector","","@skipCurrentProcess"), cms.InputTag("rawDataRepacker","","@skipCurrentProcess"))
...
delattr(process, "hltSiStripZeroSuppression")
...
#process.TFileService = cms.Service('TFileService', fileName=cms.string('openHLT_L3Mu_v1.root'))
...
outputCommands = process.RAWAODSIMEventContent.outputCommands.extend(
  cms.untracked.vstring(
    ...
    'keep *_hltL2MuonsPPOnAA_*_*',
    'keep *_hltIterL3OIMuCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter0IterL3MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter2IterL3MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter3IterL3MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter0IterL3FromL1MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter2IterL3FromL1MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltIter3IterL3FromL1MuonCtfWithMaterialTracksPPOnAA_*_*',
    'keep *_hltL3MuonsIterL3OIPPOnAA_*_*',
    'keep *_hltL3MuonsIterL3IOPPOnAA_*_*',
    'keep *_hltIterL3GlbMuonPPOnAA_*_*',
    'keep *_hltIterL3OIL3MuonCandidatesPPOnAA_*_*',
    'keep *_hltIter3IterL3MuonL2CandidatesPPOnAA_*_*',
    'keep *_hltIterL3MuonCandidatesPPOnAA_*_*'
    )
  )
process.RAWAODSIMoutput = cms.OutputModule("PoolOutputModule",
  ...
  fileName = cms.untracked.string('file:MuonL3RRAWoutput_full_327237_wL2fix.root'),
...
#process.Out.outputCommands.append( 'keep *_hltL3MuonsIter3OIPPOnAA_*_*')
