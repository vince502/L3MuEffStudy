# hltGetConfiguration /users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V4 --globaltag auto:run2_hlt_HIon --l1-emulator uGT --era Run2_2018_pp_on_AA --input root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIHardProbes/RAW/v1/000/327/237/00000/6FFC6DF6-D1A4-BD4E-918B-592DEED50B18.root --process MyHLT --full --data --unprescale --timing --no-output --max-events -1 --customise HLTrigger/Configuration/customizeHLTforCMSSW.synchronizeHCALHLTofflineRun3on2018data

# /users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V4 (CMSSW_11_1_0_pre5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/soohwan/2020RunPre_HLT/HIon2018_HLT_L3_Mu_efftest_v1/V4')
)
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIHardProbes/RAW/v1/000/327/237/00000/6FFC6DF6-D1A4-BD4E-918B-592DEED50B18.root',
    ),
...
_customInfo['inputFile' ]=  ['root://xrootd.cmsaf.mit.edu//store/hidata/HIRun2018A/HIHardProbes/RAW/v1/000/327/237/00000/6FFC6DF6-D1A4-BD4E-918B-592DEED50B18.root']
...
process.TFileService = cms.Service('TFileService', fileName=cms.string('openHLT_L3MuEffTest_fv5.root'))
